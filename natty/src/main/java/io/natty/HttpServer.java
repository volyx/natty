...
public class HttpServer {
    ...
    public HttpServer(String listenAddress, int port, TransportTypeHolder transportTypeHolder, List<Object> restApi) {
...
//                        .addLast(new HttpUploadServerHandler())
    ...
    public ChannelFuture close() {
        System.out.println("Shutting Http HttpServer ...");
